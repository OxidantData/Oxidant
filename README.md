...
GNU Affero General Public License v3.0 — see [`LICENSE`](LICENSE). Snapshots at or before
commit `b18eead` remain available under Apache-2.0. Commercial licensing:
