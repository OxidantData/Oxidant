#!/usr/bin/env python3
"""Golden checksums: compute TPC-DS SF10 answers via DuckDB and compare against
...
DuckDB f64) and ORDER BY…LIMIT boundary picks incl. null-ordering (Q11/Q12) —
with the reason printed per query and benign queries listed separately in the
summary. The canonicalization and verdict rules live in golden_common.py (run
