...
def qualify(sql: str, database: str) -> str:
    ...
    Interval rewrite stays a separate transform; relation qualification does
    not rewrite literals, comments or aliases (OxidantData/Oxidant#186).
    """
    body = rewrite_bare_intervals(sql)
    return qualify_relations(body, TABLES, "glue", database)
