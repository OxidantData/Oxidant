...
| `OXIDANT_MEMORY_LIMIT_BYTES` | Recommended | DataFusion spill pool size (e.g. `26000000000` on a 32 GB node). |
...
| `OXIDANT_MEMORY_LIMIT_BYTES` | Recommended | Same spill pool tuning as the driver. |
