# Spark SQL builtin-function coverage
...
Spark builtin-function surface scraped 2026-08-29 (source: Spark SQL builtin-functions reference manual).
...
| | |
|---|---:|
| Documented Spark functions | 606 |
| In scope for Oxidant | 440 |
| **Registered today** | **324 (73.6%)** |
| Missing | 116 |
| Engine registry size (incl. undocumented names) | 457 |
