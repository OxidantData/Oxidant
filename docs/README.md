...
| Doc | Purpose |
|-----|---------|
| [architecture.md](architecture.md) | Engine design: Loom vectorized core, Connect path |
| [CODEMAP.md](CODEMAP.md) | Crate / bench / deploy ownership map |
| [spark-coverage.md](spark-coverage.md) | Spark SQL manual coverage matrix: statements / functions / types / operators, with probe evidence |
| [spark-functions.md](spark-functions.md) | Exact builtin-function coverage: oxidant's live registry vs. all 606 documented Spark functions. **Generated** — regenerate with `oxidant-parity functions --markdown`, never hand-edit |
