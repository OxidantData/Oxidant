//! `oxidant-catalog-hive` — a [`CatalogProvider`] backed by a Hive Metastore.
//!
...
//! `spark.sql.catalog.<name>.uri=thrift://host:9083` — which `oxidant-connect`'s catalog factory turns
