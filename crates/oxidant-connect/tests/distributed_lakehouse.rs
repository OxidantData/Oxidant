...
//! per-worker file shards of a real cluster, where `OXIDANT_WORKER_COUNT`/`OXIDANT_SHARD_INDEX`
...
/// delta-kernel-rs will resolve, same shape as oxidant-loom's `reads_a_delta_table` fixture.
