...
async fn plan_strict(planner: &Engine, sql: &str) -> weft_execution::plan::DistributedQuery {
...
fn assert_split_union_shape(dq: &weft_execution::plan::DistributedQuery, n_group_cols: usize) {
