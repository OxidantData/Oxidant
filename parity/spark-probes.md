# Spark SQL coverage probes (KAN-89)

Companion to [`docs/spark-coverage.md`](../docs/spark-coverage.md).
...
KAN-90 owns a reproducible Spark SQL corpus for the parity harness; use
...
Every other Evidence cell in `docs/spark-coverage.md` that quotes SQL is a
